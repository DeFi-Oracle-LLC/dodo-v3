...
import {IDODOApproveProxy} from "mock/DODOApproveProxy.sol";
...
contract D3Proxy is IDODOSwapCallback {
    ...
    constructor(address approveProxy, address weth, address v3Factory) {
    ...
    function d3MMSwapCallBack(address token, uint256 value, bytes calldata _data) external override {
        require(ID3Factory(_V3_FACTORY_)._POOL_WHITELIST_(msg.sender), "D3PROXY_CALLBACK_INVALID");
